...
const customNodesSerializer = Object.fromEntries(customNodes.map((node) => [node.name, node.toGovspeak]))

const nodesSerializer = Object.assign(defaultNodesSerializer, customNodesSerializer);
