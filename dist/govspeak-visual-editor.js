...
V.prototype = {
  ...
  update: function (n, e, t) {
    var r = t && t != n ? this.remove(t) : this,
      ...
      s = r.content.slice();
    return (
      o == -1 ? s.push(t || n, e) : ((s[o + 1] = e), t && (s[o] = t)), new V(s)
    );
  },
  // :: (string) → OrderedMap
...
function yi(n, e, t, r) {
  for (let o = n.childCount, s = e.childCount; ; ) {
    ...
    if (i.isText && i.text != l.text) {
      ...
      for (
        ;
        a < u && i.text[i.text.length - a - 1] == l.text[l.text.length - a - 1];
    ...
    if (t > e)
      for (let s = 0, i = 0; i < t; s++) {
        ...
        c > e &&
          ((i < e || c > t) &&
            (l.isText
              ? (l = l.cut(Math.max(0, e - i), Math.min(l.text.length, t - i)))
              : (l = l.cut(
                  Math.max(0, e - i - 1),
...
function dn(n, e) {
  ...
  if (t) {
    ...
    for (let r = 0; r < n.length; r++) if (!dn(n[r], e[r])) return !1;
  } else {
    for (let r in n) if (!(r in e) || !dn(n[r], e[r])) return !1;
...
class C {
  ...
  */
  removeBetween(e, t) {
    return new C(
      xi(this.content, e + this.openStart, t + this.openStart),
      this.openStart,
      this.openEnd,
    );
  }
...
function Ot(n, e, t, r) {
  ...
  n &&
    ((s = n.index(t)),
    n.depth > t ? s++ : n.textOffset && (Ze(n.nodeAfter, r), s++));
  for (let l = s; l < i; l++) Ze(o.child(l), r);
...
function Si(n, e, t, r, o) {
  let s = n.depth > o && Er(n, e, o + 1),
    i = r.depth > o && Er(t, r, o + 1),
    l = [];
  return (
    Ot(null, n, o, l),
    s && i && e.index(o) == t.index(o)
      ? (vi(s, i), Ze(Ye(s, Si(n, e, t, r, o + 1)), l))
      : (s && Ze(Ye(s, gn(n, e, o + 1)), l),
        Ot(e, t, o, l),
        i && Ze(Ye(i, gn(t, r, o + 1)), l)),
    Ot(r, null, o, l),
    new k(l)
  );
}
...
function mc(n, e) {
  ...
  for (let s = t - 1; s >= 0; s--) o = e.node(s).copy(k.from(o));
  return {
...
let Qe = class Ar {
  ...
  */
  hasMarkup(e, t, r) {
    return (
      this.type == e &&
      dn(this.attrs, t || e.defaultAttrs || bc) &&
      O.sameSet(this.marks, r || O.none)
    );
  }
  /**
  ...
  */
  copy(e = null) {
    return e == this.content
      ? this
      : new Ar(this.type, this.attrs, e, this.marks);
  }
  /**
  ...
  */
  mark(e) {
    return e == this.marks
      ? this
      : new Ar(this.type, this.attrs, this.content, e);
  }
  /**
  ...
  */
  ...
  toString() {
    return this.type.spec.toDebugString
      ...
      : _i(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
...
class tt {
  ...
  */
  static parse(e, t) {
    let r = new kc(e, t);
    if (r.next == null) return tt.empty;
    let o = Di(r);
...
function Ti(n) {
  let e = /* @__PURE__ */ Object.create(null);
  if (n) for (let t in n) e[t] = new Ec(n[t]);
  return e;
}
let To = class Oi {
  /**
  ...
  */
  constructor(e, t, r) {
    (this.name = e),
      ...
      (this.attrs = Ti(r.attrs)),
      (this.defaultAttrs = Ai(this.attrs)),
  ...
  */
  createChecked(e = null, t, r) {
    return (
      (t = k.from(t)),
      this.checkContent(t),
      new Qe(this, this.computeAttrs(e), t, O.setFrom(r))
    );
  }
  /**
  ...
  */
  constructor(e) {
    ...
    (t.nodes = V.from(e.nodes)),
      ...
      (this.nodes = To.compile(this.spec.nodes, this)),
      (this.marks = Tn.compile(this.spec.marks, this));
    let r = /* @__PURE__ */ Object.create(null);
    for (let o in this.nodes) {
      ...
      let s = this.nodes[o],
        i = s.spec.content || "",
        l = s.spec.marks;
      (s.contentMatch = r[i] || (r[i] = tt.parse(i, this.nodes))),
...
class gt {
  ...
  matchStyle(e, t, r, o) {
    for (
      ...
      if (
        !(
          l.indexOf(e) != 0 ||
          (i.context && !r.matchesContext(i.context)) || // Test that the style string either precisely matches the prop,
  ...
  */
  static fromSchema(e) {
    return (
      e.cached.domParser || (e.cached.domParser = new gt(e, gt.schemaRules(e)))
    );
  }
}
const qi = {
...
class nn {
  constructor(e, t, r, o, s, i, l) {
    (this.type = e),
      ...
      (this.options = l),
      (this.content = []),
      (this.activeMarks = O.none),
      (this.stashMarks = []),
      (this.match = i || (l & Nt ? null : e.contentMatch));
  }
  findWrapping(e) {
    if (!this.match) {
      if (!this.type) return [];
  ...
  applyPending(e) {
    for (let t = 0, r = this.pendingMarks; t < r.length; t++) {
      let o = r[t];
      (this.type ? this.type.allowsMarkType(o.type) : Nc(o.type, e)) &&
  ...
  inlineContext(e) {
    return this.type
      ...
      : this.content.length
        ...
        : e.parentNode &&
          !qi.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class qo {
  constructor(e, t, r) {
    ...
    let o = t.topNode,
      s,
      i = No(null, t.preserveWhitespace, 0) | (r ? Nt : 0);
    o
      ? (s = new nn(
          o.type,
          o.attrs,
      ...
      : r
        ? (s = new nn(null, null, O.none, O.none, !0, null, i))
        : (s = new nn(e.schema.topNodeType, null, O.none, O.none, !0, null, i)),
      (this.nodes = [s]),
...
`),
  ...
  addElementByRule(e, t, r) {
    ...
    if (s && s.isLeaf) this.findInside(e);
      ...
      this.findInside(e),
        t.getContent(e, this.parser.schema).forEach((c) => this.insertNode(c));
    else {
      let c = e;
  ...
  enterInner(e, t = null, r = !1, o) {
    ...
    s.options & Nt && s.content.length == 0 && (i |= Nt),
      this.nodes.push(new nn(e, t, s.activeMarks, s.pendingMarks, r, null, i)),
      this.open++;
  }
...
class _e {
  ...
  */
  serializeNodeInner(e, t) {
    let { dom: r, contentDOM: o } = _e.renderSpec(
      Kn(t),
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= f) {
        let h = a ? (e == c ? -1 : e == f ? 1 : t) : t,
          p = c + o + (h < 0 ? 0 : u);
        if (r) return p;
        let d = e == (t < 0 ? c : f) ? null : Rc(l / 3, e - c),
          m = e == c ? Li : e == f ? zi : fn;
...
class J {
  ...
  */
  static jsonID(e, t) {
    if (e in Zn) throw new RangeError("Duplicate use of step JSON ID " + e);
  ...
  */
  static fromReplace(e, t, r, o) {
    try {
      ...
      if (s instanceof mn) return L.fail(s.message);
      throw s;
    }
  }
}
function Yr(n, e, t) {
  ...
  for (let o = 0; o < n.childCount; o++) {
    let s = n.child(o);
    s.content.size && (s = s.copy(Yr(s.content, e, s))),
...
class be extends J {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to),
      r = new C(
        Yr(t.content, (o) => o.mark(this.mark.removeFromSet(o.marks)), e),
        t.openStart,
        t.openEnd,
      );
  ...
  merge(e) {
    return e instanceof be &&
      ...
      this.from <= e.to &&
      this.to >= e.from
      ? new be(Math.min(this.from, e.from), Math.max(this.to, e.to), this.mark)
      : null;
  }
  toJSON() {
    return {
...
class Ie extends J {
  ...
  */
  ...
  apply(e) {
    ...
    return L.fromReplace(
      e,
      this.pos,
      this.pos + 1,
      new C(k.from(r), 0, t.isLeaf ? 0 : 1),
    );
  }
  invert(e) {
    let t = e.nodeAt(this.pos);
    if (t) {
      ...
      if (r.length == t.marks.length) {
        for (let o = 0; o < t.marks.length; o++)
          if (!t.marks[o].isInSet(r)) return new Ie(this.pos, t.marks[o]);
  ...
  */
  ...
  apply(e) {
    return this.structure && Tr(e, this.from, this.to)
      ? L.fail("Structure replace would overwrite content")
      : L.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
  ...
  map(e) {
    ...
    return t.deletedAcross && r.deletedAcross
      ? null
      : new j(t.pos, Math.max(t.pos, r.pos), this.slice);
  }
  merge(e) {
    if (!(e instanceof j) || e.structure || this.structure) return null;
    if (
...
class U extends J {
  ...
  */
  ...
  apply(e) {
    ...
    return r
      ? L.fromReplace(e, this.from, this.to, r)
      : L.fail("Content does not fit in gap");
  }
  getMap() {
    return new te([
      this.from,
  ...
  map(e) {
    ...
    return (t.deletedAcross && r.deletedAcross) || o < t.pos || s > r.pos
      ? null
      : new U(t.pos, r.pos, o, s, this.slice, this.insert, this.structure);
  }
  toJSON() {
    let e = {
...
function Tr(n, e, t) {
  let r = n.resolve(e),
    o = t - e,
    s = r.depth;
  for (; o > 0 && s > 0 && r.indexAfter(s) == r.node(s).childCount; ) s--, o--;
  if (o > 0) {
    ...
    if (!u) s.push(new j(i, a, C.empty));
      ...
      if (c.isText && !t.spec.code) {
        ...
        for (; (f = h.exec(c.text)); )
          p ||
            (p = new C(
              k.from(t.schema.text(" ", t.allowedMarks(c.marks))),
              0,
              0,
            )),
            s.push(new j(i + f.index, i + f.index + f[0].length, p));
      }
    }
    i = a;
  }
...
function Kt(n) {
  ...
  for (let r = n.depth; ; --r) {
    ...
    if (r == 0 || o.type.spec.isolating || !Bc(o, s, i)) break;
  }
  return null;
}
function Pc(n, e, t) {
  ...
  for (let d = s, m = !1; d > t; d--)
    m || r.index(d) > 0
      ? ((m = !0), (u = k.from(r.node(d).copy(u))), f++)
      : c--;
  let h = k.empty,
    p = 0;
  for (let d = s, m = !1; d > t; d--)
    m || o.after(d + 1) < o.end(d)
      ? ((m = !0), (h = k.from(o.node(d).copy(h))), p++)
      : a++;
      ...
      return (
        n.step(
          new U(
            ...
            a + 1,
            u - 1,
            new C(k.from(r.create(o, null, i.marks)), 0, 0),
            1,
            !0,
          ),
        ),
...
function Vi(n, e, t = -1) {
  ...
  for (let o = r.depth; ; o--) {
    ...
    if (
      ...
      s && !s.isTextblock && Pi(s, i) && r.node(o).canReplace(l, l + 1))
    )
      return e;
    if (o == 0) break;
...
class Zc {
  ...
  fit() {
    ...
    let s = this.placed,
      i = r.depth,
      l = o.depth;
    for (; i && l && s.childCount == 1; ) (s = s.firstChild.content), i--, l--;
    let c = new C(s, i, l);
    return e > -1
      ? new U(r.pos, e, this.$to.pos, this.$to.end(), c, t)
    ...
    for (let t = 1; t <= 2; t++)
      for (let r = t == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        let o,
          s = null;
        r
          ? ((s = Yn(this.unplaced.content, r - 1).firstChild), (o = s.content))
        ...
        for (let l = this.depth; l >= 0; l--) {
          ...
          if (
            t == 1 &&
            (i
              ? a.matchType(i.type) || (f = a.fillBefore(k.from(i), !1))
  ...
  dropNode() {
    ...
    } else this.unplaced = new C(At(e, t, 1), t, r);
  }
  ...
  placeNodes({
    ...
    d || (p = -1),
      (this.placed = Mt(this.placed, t, k.from(u))),
    ...
    this.unplaced = d
      ? e == 0
        ? C.empty
        : new C(At(i.content, e - 1, 1), e - 1, p < 0 ? i.openEnd : e - 1)
      : new C(At(i.content, e, a), i.openStart, i.openEnd);
  }
  mustMoveInline() {
    ...
    if (
      !e.type.isTextblock ||
      !Qn(this.$to, this.$to.depth, e.type, e.match, !1) ||
  ...
  close(e) {
    ...
    t.fit.childCount && (this.placed = Mt(this.placed, t.depth, t.fit)),
      (e = t.move);
  ...
  openFrontierNode(e, t = null, r) {
    ...
    (o.match = o.match.matchType(e)),
      (this.placed = Mt(this.placed, this.depth, k.from(e.create(t, r)))),
...
function At(n, e, t) {
  return e == 0
    ...
    : n.replaceChild(0, n.firstChild.copy(At(n.firstChild.content, e - 1, t)));
}
function Mt(n, e, t) {
  return e == 0
    ? n.append(t)
    : n.replaceChild(
        n.childCount - 1,
        n.lastChild.copy(Mt(n.lastChild.content, e - 1, t)),
      );
}
function Yn(n, e) {
...
function Hi(n, e, t) {
  ...
  return (
    e > 1 &&
      (r = r.replaceChild(
        0,
        Hi(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0),
      )),
    e > 0 &&
      ((r = n.type.contentMatch.fillBefore(r).append(r)),
      t <= 0 &&
        (r = r.append(
          n.type.contentMatch.matchFragment(r).fillBefore(k.empty, !0),
        ))),
    n.copy(r)
  );
}
...
function Xc(n, e, t, r) {
  ...
  let o = n.doc.resolve(e),
    s = n.doc.resolve(t);
  if (Ui(o, s, r)) return n.step(new j(e, t, r));
      ...
      for (let m = 0; m < i.length; m++) {
        ...
        if (y.canReplaceWith(S, S, d.type, d.marks))
          return n.replace(
            o.before(g),
            b ? s.after(g) : t,
            new C(ji(r.content, 0, r.openStart, p), p, r.openEnd),
          );
      }
  }
...
class na {
  ...
  */
  step(e) {
    ...
    if (t.failed) throw new kt(t.failed);
    return this;
  }
  /**
...
class T {
  ...
  */
  constructor(e, t, r) {
    (this.$anchor = e),
      (this.$head = t),
      (this.ranges = r || [new ra(e.min(t), e.max(t))]);
  }
  /**
  ...
  */
  replace(e, t = C.empty) {
    ...
    for (let l = 0; l < i.length; l++) {
      let { $from: c, $to: a } = i[l],
        u = e.mapping.slice(s);
      e.replaceRange(u.map(c.pos), u.map(a.pos), l ? C.empty : t),
        l == 0 && Po(e, s, (r ? r.isInline : o && o.isTextblock) ? -1 : 1);
    }
  }
  /**
  ...
  */
  replaceWith(e, t) {
    ...
    for (let s = 0; s < o.length; s++) {
      ...
      s
        ? e.deleteRange(a, u)
        : (e.replaceRangeWith(a, u, t), Po(e, r, t.isInline ? -1 : 1));
    }
  }
  /**
  ...
  */
  static findFrom(e, t, r = !1) {
    let o = e.parent.inlineContent
      ? new I(e)
      : at(e.node(0), e.parent, e.pos, e.index(), t, r);
    if (o) return o;
    for (let s = e.depth - 1; s >= 0; s--) {
      let i =
        t < 0
          ? at(e.node(0), e.node(s), e.before(s + 1), e.index(s), t, r)
          : at(e.node(0), e.node(s), e.after(s + 1), e.index(s) + 1, t, r);
      if (i) return i;
    }
    return null;
  }
...
function Po(n, e, t) {
  ...
  if (r < e) return;
  let o = n.steps[r];
  if (!(o instanceof j || o instanceof U)) return;
...
class sa extends na {
  ...
  */
  setSelection(e) {
    ...
    return (
      (this.curSelection = e),
      (this.curSelectionFor = this.steps.length),
      (this.updated = (this.updated | Vo) & ~rn),
  ...
  */
  ensureMarks(e) {
    return (
      O.sameSet(this.storedMarks || this.selection.$from.marks(), e) ||
  ...
  replaceSelectionWith(e, t = !0) {
    ...
    return (
      t &&
        (e = e.mark(
          this.storedMarks ||
            (r.empty ? r.$from.marks() : r.$from.marksAcross(r.$to) || O.none),
        )),
      ...
      t &&
        t.forEach((r) => {
          ...
          this.plugins.push(r),
            ...
            r.spec.state && this.fields.push(new Tt(r.key, r.spec.state, r));
        });
  }
}
class ft {
  ...
  */
  static create(e) {
    let t = new er(e.doc ? e.doc.type.schema : e.schema, e.plugins),
      r = new ft(t);
  ...
  */
  reconfigure(e) {
    let t = new er(this.schema, e.plugins),
      r = t.fields,
      o = new ft(t);
  ...
  */
  static fromJSON(e, t, r) {
    ...
    let o = new er(e.schema, e.plugins),
      s = new ft(o);
    return (
      o.fields.forEach((i) => {
        if (i.name == "doc") s.doc = Qe.fromJSON(e.schema, t.doc);
...
class $e {
  ...
  */
  constructor(e) {
    (this.spec = e),
      (this.props = {}),
      e.props && Ji(e.props, this, this.props),
      (this.key = e.key ? e.key.key : Gi("plugin"));
  }
  /**
...
function jo(n, e, t, r, o) {
  for (;;) {
    ...
    if (e == (o < 0 ? 0 : ge(n))) {
      ...
      if (
        ((n = n.childNodes[e + (o < 0 ? -1 : 0)]), n.contentEditable == "false")
      )
        return !1;
      e = o < 0 ? ge(n) : 0;
    } else return !1;
...
const Nn = function (n) {
  return (
    n.focusNode && nt(n.focusNode, n.focusOffset, n.anchorNode, n.anchorOffset)
  );
};
function We(n, e) {
...
const ke = typeof navigator < "u" ? navigator : null,
  Wo = typeof document < "u" ? document : null,
  Ue = (ke && ke.userAgent) || "",
  Or = /Edge\/(\d+)/.exec(Ue),
  Zi = /MSIE \d/.exec(Ue),
  Nr = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Ue),
  ee = !!(Zi || Nr || Or),
  ze = Zi ? document.documentMode : Nr ? +Nr[1] : Or ? +Or[1] : 0,
  he = !ee && /gecko\/(\d+)/i.test(Ue);
he && +(/Firefox\/(\d+)/.exec(Ue) || [0, 0])[1];
const qr = !ee && /Chrome\/(\d+)/.exec(Ue),
  W = !!qr,
  fa = qr ? +qr[1] : 0,
  Z = !ee && !!ke && /Apple Computer/.test(ke.vendor),
  yt = Z && (/Mobile\/\w+/.test(Ue) || (!!ke && ke.maxTouchPoints > 2)),
  se = yt || (ke ? /Mac/.test(ke.platform) : !1),
  ha = ke ? /Win/.test(ke.platform) : !1,
  ue = /Android \d/.test(Ue),
  Zt = !!Wo && "webkitFontSmoothing" in Wo.documentElement.style,
  pa = Zt
...
function Jo(n, e, t) {
  ...
  for (let i = t || n.dom; i; i = $t(i)) {
    ...
    let l = i,
      ...
      f = 0;
    if (
      (e.top < a.top + Ce(r, "top")
        ? (f = -(a.top - e.top + Ce(o, "top")))
        : e.bottom > a.bottom - Ce(r, "bottom") &&
          (f =
            e.bottom - e.top > a.bottom - a.top
              ? e.top + Ce(o, "top") - a.top
              : e.bottom - a.bottom + Ce(o, "bottom")),
      e.left < a.left + Ce(r, "left")
        ? (u = -(a.left - e.left + Ce(o, "left")))
        : e.right > a.right - Ce(r, "right") &&
          (u = e.right - a.right + Ce(o, "right")),
      u || f)
    )
...
function Xi(n, e) {
  ...
  for (let u = n.firstChild, f = 0; u; u = u.nextSibling, f++) {
    ...
    else if (u.nodeType == 3) h = ve(u).getClientRects();
    else continue;
...
function va(n, e) {
  ...
  if (!i || !n.dom.contains(i.nodeType != 1 ? i.parentNode : i)) {
    ...
    if (!no(e, a) || ((i = el(n.dom, e, a)), !i)) return null;
  }
  if (Z) for (let a = i; r && a; a = $t(a)) a.draggable && (r = void 0);
  if (((i = xa(i, e)), r)) {
    if (
      he &&
      r.nodeType == 1 &&
...
const Sa = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function tl(n, e, t) {
  let { node: r, offset: o, atom: s } = n.docView.domFromPos(e, t < 0 ? -1 : 1),
    i = Zt || he;
  if (r.nodeType == 3)
    if (i && (Sa.test(r.nodeValue) || (t < 0 ? !o : o == r.nodeValue.length))) {
      ...
      if (he && o && /\s/.test(r.nodeValue[o - 1]) && o < r.nodeValue.length) {
        ...
        if (a.top == c.top) {
          ...
          if (u.top != c.top) return Dt(u, u.left < a.left);
        }
      }
      return c;
    } else {
        ...
        t < 0 && !o
          ...
          : t >= 0 && o == r.nodeValue.length
            ...
            : t < 0
              ? c--
              : a++,
        Dt(Me(ve(r, c, a), u), u < 0)
      );
    }
  if (!n.state.doc.resolve(e - (s || 0)).parent.inlineContent) {
    if (s == null && o && (t < 0 || o == ge(r))) {
      let c = r.childNodes[o - 1];
      if (c.nodeType == 1) return nr(c.getBoundingClientRect(), !1);
    }
    if (s == null && o < ge(r)) {
      let c = r.childNodes[o];
      if (c.nodeType == 1) return nr(c.getBoundingClientRect(), !0);
    }
...
function Ea(n, e, t) {
  ...
  let o = r.parentOffset,
    ...
    l = n.domSelection();
  return !Da.test(r.parent.textContent) || !l.modify
    ? t == "left" || t == "backward"
      ? s
      : i
    : nl(n, e, () => {
...
function Aa(n, e, t) {
  return Ko == e && Zo == t
    ...
    : ((Ko = e),
      (Zo = t),
      (Yo = t == "up" || t == "down" ? _a(n, e, t) : Ea(n, e, t)));
}
const ce = 0,
  Qo = 1,
  Je = 2,
...
class Yt {
  ...
  localPosFromDOM(e, t, r) {
    ...
    let o;
    if (e == this.dom && this.contentDOM) o = t > K(this.contentDOM);
    else if (
      this.contentDOM &&
  ...
  domFromPos(e, t) {
    ...
    for (
      let s;
      r && !(s = this.children[r - 1]).size && s instanceof rl && s.side >= 0;
      r--
    );
    if (t <= 0) {
      let s,
      ...
      return s && t && i && !s.border && !s.domAtom
        ...
        : { node: this.contentDOM, offset: s ? K(s.dom) + 1 : 0 };
    } else {
      let s,
        i = !0;
      for (
      ...
      return s && i && !s.border && !s.domAtom
        ...
        : {
            ...
            offset: s ? K(s.dom) : this.contentDOM.childNodes.length,
          };
    }
  }
...
`
          ...
          for (let d = h, m; d; d = d.parentNode) {
            if ((m = d.nextSibling)) {
              m.nodeName == "BR" &&
                (l = c = { node: m.parentNode, offset: K(m) + 1 });
              break;
            }
            let g = d.pmViewDesc;
    ...
    if (
      !(o || (u && Z)) &&
      nt(l.node, l.offset, a.anchorNode, a.anchorOffset) &&
      nt(c.node, c.offset, a.focusNode, a.focusOffset)
    )
      return;
    let f = !1;
    if ((a.extend || e == t) && !u) {
...
class rt extends Yt {
  ...
  static create(e, t, r, o) {
    let s = o.nodeViews[t.type.name],
      i = s && s(t, o, r);
    return (
      (!i || !i.dom) && (i = _e.renderSpec(document, t.type.spec.toDOM(t, r))),
      new rt(e, t, i.dom, i.contentDOM || i.dom)
    );
  }
  parseRule() {
  ...
  slice(e, t, r) {
    let o = rt.create(this.parent, this.mark, !0, r),
      s = this.children,
      i = this.size;
...
class Le extends Yt {
  ...
  static create(e, t, r, o, s, i) {
    ...
    if (t.isText) {
      ...
      u ||
        ({ dom: u, contentDOM: f } = _e.renderSpec(
          document,
          t.type.spec.toDOM(t),
        ));
    !f &&
    ...
    return (
      (u = ll(u, r, t)),
      a
        ? (c = new Ta(e, t, r, o, u, f || null, h, a, s, i + 1))
        : t.isText
          ? new qn(e, t, r, o, u, h, s)
          : new Le(e, t, r, o, u, f || null, h, s, i + 1)
    );
  }
  parseRule() {
  ...
  updateChildren(e, t) {
    ...
    Ia(
      ...
      (a, u, f) => {
        a.spec.marks
          ...
          : a.type.side >= 0 &&
            !f &&
            c.syncToMarks(
              u == this.node.childCount ? O.none : this.node.child(u).marks,
              r,
              e,
            ),
          c.placeWidget(a, e, o);
      ...
      c.destroyRest(),
      (c.changed || this.dirty == Je) &&
        (i && this.protectLocalComposition(e, i),
        sl(this.contentDOM, this.children, e),
        yt && Fa(this.dom));
  }
  localCompositionInfo(e, t) {
    ...
    let s = e.domSelectionRange(),
      i = za(s.focusNode, s.focusOffset);
    if (!i || !this.dom.contains(i.parentNode)) return null;
    if (this.node.inlineContent) {
      let l = i.nodeValue,
        c = La(this.node.content, l, r - t, o - t);
  ...
  protectLocalComposition(e, { node: t, pos: r, text: o }) {
    ...
    e.input.compositionNodes.push(i),
      (this.children = Fr(this.children, r, r + o.length, e, i));
  }
...
class qn extends Le {
  ...
  update(e, t, r, o) {
    return this.dirty == ye ||
      (this.dirty != ce && !this.inParent()) ||
      !e.sameMarkup(this.node)
      ? !1
      : (this.updateOuterDeco(t),
        (this.dirty != ce || e.text != this.node.text) &&
    ...
    if (i) {
      ...
      for (let l in i) {
        ...
        c != null &&
          (t &&
            o.length == 1 &&
            o.push((r = new qt(e.isInline ? "span" : "div"))),
          l == "class"
...
class Na {
  constructor(e, t, r) {
    (this.lock = t),
      ...
      (this.changed = !1),
      (this.top = e),
      (this.preMatch = qa(e.node.content, e));
  }
  ...
  findNodeMatch(e, t, r, o) {
    ...
    if (
      ...
      (i = this.preMatch.matches[o - this.preMatch.index]).parent == this.top &&
      i.matchesNode(e, t, r)
    )
  ...
  updateNodeAt(e, t, r, o, s) {
    ...
    return (
      i.dirty == ye && i.dom == i.contentDOM && (i.dirty = Je),
      i.update(e, t, r, s)
      ...
      if (c instanceof Le) {
        ...
        if (!h && (f = this.recreateWrapper(c, e, t, r, o, i)))
          return (
            ...
            f.contentDOM &&
              ((f.dirty = Je), f.updateChildren(o, i + 1), (f.dirty = ce)),
            (this.changed = !0),
            this.index++,
            !0
          );
  ...
  addTextblockHacks() {
    let e = this.top.children[this.index - 1],
      t = this.top;
    for (; e instanceof rt; ) (t = e), (e = t.children[t.children.length - 1]);
    (!e || // Empty textblock
      !(e instanceof qn) ||
      /\n$/.test(e.node.text) ||
  ...
  e: for (; o > 0; ) {
    ...
    for (;;)
      if (r) {
        ...
        if (a instanceof rt) (t = a), (r = a.children.length);
        else {
          (l = a), r--;
          break;
        }
...
function La(n, e, t, r) {
  for (let o = 0, s = 0; o < n.childCount && s <= r; ) {
    ...
    if (s >= t) {
      if (s >= r && c.slice(r - e.length - l, r - l) == e) return r - e.length;
...
function ro(n, e = null) {
  ...
  if (Nn(t)) {
    ...
    if (
      ...
      _.isSelectable(u) &&
      o.parent &&
      !(u.isInline && ca(t.focusNode, t.focusOffset, o.dom))
    ) {
      let f = o.posBefore;
...
function cl(n) {
  return n.editable
    ? n.hasFocus()
    : ul(n) && document.activeElement && document.activeElement.contains(n.dom);
}
function De(n, e = !1) {
  ...
  if ((al(n, t), !!cl(n))) {
    if (!e && n.input.mouseDown && n.input.mouseDown.allowDefault && W) {
      ...
      if (
        r.anchorNode &&
        o.anchorNode &&
        nt(r.anchorNode, r.anchorOffset, o.anchorNode, o.anchorOffset)
      ) {
    ...
    if ((n.domObserver.disconnectSelection(), n.cursorWrapper)) Pa(n);
    else {
      ...
      ts &&
        !(t instanceof I) &&
        (t.$from.parent.inlineContent || (s = ns(n, t.from)),
        !t.empty && !t.$from.parent.inlineContent && (i = ns(n, t.to))),
        ...
        t.visible
          ...
          : (n.dom.classList.add("ProseMirror-hideselection"),
            "onselectionchange" in document && Ba(n));
    }
...
function ns(n, e) {
  ...
  if (Z && o && o.contentEditable == "false") return rr(o);
  if (
...
function rr(n) {
  return (
    ...
    Z && n.draggable && ((n.draggable = !1), (n.wasDraggable = !0)),
    n
  );
}
function rs(n) {
  ...
  e.addEventListener(
    ...
    (n.input.hideSelectionGuard = () => {
      (t.anchorNode != r || t.anchorOffset != o) &&
        (e.removeEventListener("selectionchange", n.input.hideSelectionGuard),
        setTimeout(() => {
          (!cl(n) || n.state.selection.visible) &&
            n.dom.classList.remove("ProseMirror-hideselection");
        }, 20));
    }),
  );
...
function Pa(n) {
  let e = n.domSelection(),
    ...
    o = r.nodeName == "IMG";
  o ? t.setEnd(r.parentNode, K(r) + 1) : t.setEnd(r, 0),
    t.collapse(!1),
    e.removeAllRanges(),
    e.addRange(t),
    !o &&
...
function al(n, e) {
  if (e instanceof _) {
    ...
    t != n.lastSelectedViewDesc &&
      (ss(n), t && t.selectNode(), (n.lastSelectedViewDesc = t));
  } else ss(n);
}
function ss(n) {
    ...
    if (t.indexOf("s") > -1) {
      ...
      if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
        ...
        return s.isAtom || ((i = n.docView.descAt(l)) && !i.contentDOM)
          ? _.isSelectable(s)
            ? Te(n, new _(e < 0 ? n.state.doc.resolve(o.pos - s.nodeSize) : o))
            : Zt
              ? Te(n, new I(n.state.doc.resolve(e < 0 ? l : l + s.nodeSize)))
              : !1
          : !1;
      }
    } else return !1;
...
function $a(n) {
  ...
  let o,
    ...
    i = !1;
  for (
    he && t.nodeType == 1 && r < wn(t) && Rt(t.childNodes[r], -1) && (i = !0);
    ;
...
function ja(n, e) {
  for (; n && !e && !to(n); ) (e = K(n)), (n = n.parentNode);
  for (; n && e; ) {
...
function as(n, e, t) {
  ...
  if (!o.parent.inlineContent || n.endOfTextblock(e < 0 ? "up" : "down")) {
    let i = zr(n.state, e);
    if (i && i instanceof _) return Te(n, i);
  }
...
function Wa(n) {
  if (!Z || n.state.selection.$head.parentOffset > 0) return !1;
...
function Ga(n, e) {
  let t = e.keyCode,
    r = Ja(e);
  if (t == 8 || (se && t == 72 && r == "c")) return us(n, -1) || lt(n, -1);
...
function hl(n, e) {
  ...
  let i = n.someProp("clipboardSerializer") || _e.fromSchema(n.state.schema),
    l = kl(),
      ...
      (l =
        e < 0
          ? i
              ...
              .fillBefore(l, s <= o)
              .append(l)
          : l.append(i.contentMatchAt(i.childCount).fillBefore(k.empty, !0))),
...
function hs(n, e, t) {
  return (
    e < n.openStart &&
      (n = new C(
        Br(n.content, -1, e, n.openStart, 0, n.openEnd),
        e,
        n.openEnd,
      )),
    t < n.openEnd &&
      (n = new C(Br(n.content, 1, t, n.openEnd, 0, 0), n.openStart, t)),
    n
  );
}
const bl = {
...
function Ya(n) {
  ...
  let t = kl().createElement("div"),
    r = /<([a-z][^>\s]+)/i.exec(n),
    o;
  if (
    ((o = r && bl[r[1].toLowerCase()]) &&
      (n =
        o.map((s) => "<" + s + ">").join("") +
        n +
        o
...
function Qa(n) {
  let e = n.querySelectorAll(
    W ? "span:not([class]):not([style])" : "span.Apple-converted-space",
  );
  for (let t = 0; t < e.length; t++) {
    let r = e[t];
  ...
  n.someProp("handleDOMEvents", (e) => {
    for (let t in e)
      n.input.eventHandlers[t] ||
        n.dom.addEventListener(t, (n.input.eventHandlers[t] = (r) => so(n, r)));
  });
}
function so(n, e) {
    ...
    if (
      ...
      (n.input.lastIOSEnter = r),
        (n.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          n.input.lastIOSEnter == r &&
            (n.someProp("handleKeyDown", (o) => o(n, We(13, "Enter"))),
            (n.input.lastIOSEnter = 0));
        }, 200));
    } else
      n.someProp("handleKeyDown", (r) => r(n, t)) || Ga(n, t)
        ? t.preventDefault()
        : Fe(n, "key");
};
Q.keyup = (n, e) => {
...
Q.keypress = (n, e) => {
  ...
  if (!(r instanceof I) || !r.$from.sameParent(r.$to)) {
    ...
    !/[\r\n]/.test(o) &&
      !n.someProp("handleTextInput", (s) => s(n, r.$from.pos, r.$to.pos, o)) &&
...
function lu(n, e) {
  ...
  let t = n.state.doc.resolve(e),
    r = t.nodeAfter;
  return r && r.isAtom && _.isSelectable(r)
    ? (mt(n, new _(t), "pointer"), !0)
    : !1;
}
function cu(n, e) {
  if (e == -1) return !1;
...
function uu(n, e, t, r) {
  return (
    io(n, "handleDoubleClickOn", e, t, r) ||
    n.someProp("handleDoubleClick", (o) => o(n, e, r))
  );
}
function fu(n, e, t, r) {
  return (
    io(n, "handleTripleClickOn", e, t, r) ||
...
function hu(n, e, t) {
  ...
  if (e == -1)
    return r.inlineContent
      ? (mt(n, I.create(r, 0, r.content.size), "pointer"), !0)
      : !1;
  let o = r.resolve(e);
  for (let s = o.depth + 1; s > 0; s--) {
    ...
    else if (_.isSelectable(i)) mt(n, _.create(r, l), "pointer");
    else continue;
    return !0;
  }
}
  ...
  i &&
    (s == "singleClick"
      ? (n.input.mouseDown && n.input.mouseDown.done(),
        (n.input.mouseDown = new pu(n, i, t, !!r)))
      : (s == "doubleClick" ? uu : fu)(n, i.pos, i.inside, t)
        ? t.preventDefault()
        : Fe(n, "pointer"));
};
class pu {
  constructor(e, t, r, o) {
    ...
    ((r.button == 0 &&
      ...
      (a instanceof _ && a.from <= i && a.to > i)) &&
      (this.mightDrag = {
        node: s,
        pos: i,
  ...
  up(e) {
    ...
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Rn(e))),
      ...
      this.allowDefault || !t
        ? Fe(this.view, "pointer")
        : au(this.view, t.pos, t.inside, e, this.selectNode)
          ? e.preventDefault()
          : e.button == 0 &&
...
function xl(n, e) {
  return n.composing
    ? !0
    : Z && Math.abs(e.timeStamp - n.input.compositionEndedAt) < 500
...
function wl(n, e) {
  clearTimeout(n.input.composingTimeout),
    e > -1 && (n.input.composingTimeout = setTimeout(() => Cn(n), e));
}
function Cl(n) {
  for (
    n.composing &&
    ((n.input.composing = !1), (n.input.compositionEndedAt = mu()));
...
function Cn(n, e = !1) {
  if (!(ue && n.domObserver.flushingSoon >= 0)) {
    if (
      (n.domObserver.forceFlush(), Cl(n), e || (n.docView && n.docView.dirty))
    ) {
      let t = ro(n);
      return (
...
function ku(n, e) {
  ...
  setTimeout(() => {
    n.focus(),
      ...
      t ? Ht(n, r.value, null, o, e) : Ht(n, r.textContent, r.innerHTML, o, e);
  }, 50);
}
function Ht(n, e, t, r, o) {
  let s = pl(n, e, t, r, n.state.selection.$from);
  if (n.someProp("handlePaste", (c) => c(n, o, s || C.empty))) return !0;
  if (!s) return !1;
  let i = bu(s),
    l = i
...
Q.paste = (n, e) => {
  ...
  r && Ht(n, vl(r), r.getData("text/html"), o, t)
    ? t.preventDefault()
    : ku(n, t);
};
class Sl {
...
Y.dragstart = (n, e) => {
  ...
  let o = n.state.selection,
    s = o.empty ? null : n.posAtCoords(Rn(t)),
    i;
  if (!(s && s.pos >= o.from && s.pos <= (o instanceof _ ? o.to - 1 : o.to))) {
    if (r && r.mightDrag) i = _.create(n.state.doc, r.mightDrag.pos);
    else if (t.target && t.target.nodeType == 1) {
      let u = n.docView.nearestDesc(t.target, !0);
      u &&
        u.node.type.spec.draggable &&
        u != n.docView &&
        (i = _.create(n.state.doc, u.posBefore));
    }
  }
  let l = (i || n.state.selection).content(),
    { dom: c, text: a } = hl(n, l);
  t.dataTransfer.clearData(),
    t.dataTransfer.setData(Ut ? "Text" : "text/html", c.innerHTML),
    (t.dataTransfer.effectAllowed = "copyMove"),
    Ut || t.dataTransfer.setData("text/plain", a),
    (n.dragging = new Sl(l, !t[_l], i));
};
Y.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
Q.drop = (n, e) => {
  ...
  i
    ...
    : (i = pl(
        n,
        vl(t.dataTransfer),
        Ut ? null : t.dataTransfer.getData("text/html"),
        !1,
        s,
      ));
  let l = !!(r && !t[_l]);
  ...
  if (
    ...
    a.mapping.maps[a.mapping.maps.length - 1].forEach((m, g, b, y) => (d = y)),
      a.setSelection(oo(n, p, a.doc.resolve(d)));
  }
  ...
  if (W && ue && e.inputType == "deleteContentBackward") {
    ...
    setTimeout(() => {
      if (
        ...
        (n.dom.blur(),
        n.focus(),
        n.someProp("handleKeyDown", (s) => s(n, We(8, "Backspace"))))
      )
        return;
    ...
    return (
      ...
      (e instanceof vn &&
        ((this.spec.key && this.spec.key == e.spec.key) ||
          (this.toDOM == e.toDOM && jt(this.spec, e.spec))))
    );
  }
  destroy(e) {
...
class Be {
  ...
  eq(e) {
    return (
      this == e ||
      (e instanceof Be && jt(this.attrs, e.attrs) && jt(this.spec, e.spec))
    );
  }
  static is(e) {
...
class co {
  ...
  eq(e) {
    return (
      this == e ||
      (e instanceof co && jt(this.attrs, e.attrs) && jt(this.spec, e.spec))
    );
  }
  destroy() {}
}
...
class B {
  ...
  */
  map(e, t, r) {
    return this == H || e.maps.length == 0
      ? this
      : this.mapInner(e, t, 0, 0, r || Xe);
  }
  /**
  @internal
  */
  ...
  */
  ...
  addInner(e, t, r) {
    ...
    e.forEach((l, c) => {
      ...
      if ((u = El(t, l, a))) {
        ...
        o[s] == c
          ...
          : o.splice(s, 0, c, c + l.nodeSize, Sn(u, l, a + 1, Xe)),
          (s += 3);
      }
    });
    let i = Dl(s ? Al(t) : t, -r);
    ...
    return new B(
      i.length ? this.local.concat(i).sort(et) : this.local,
      o || this.children,
    );
  }
  /**
      ...
      default:
        return new Ne(
          e.every((t) => t instanceof B)
            ? e
            : e.reduce((t, r) => t.concat(r instanceof B ? r : r.members), []),
        );
    }
  }
}
      ...
      for (let o = t + 1; o < e.length; o++) {
        ...
        if (s.from == r.from) {
          s.to != r.to &&
            ...
            ds(e, o + 1, s.copy(r.to, s.to)));
          continue;
        } else {
          s.from < r.to &&
            (e == n && (e = n.slice()),
            (e[t] = r.copy(r.from, s.from)),
            ds(e, o, r.copy(s.from, r.to)));
          break;
        }
      }
  }
...
class Su {
  ...
  start() {
    this.observer &&
      (this.observer.takeRecords(), this.observer.observe(this.view.dom, wu)),
      this.onCharData &&
  ...
  onSelectionChange() {
    if (is(this.view)) {
      ...
      if (ee && ze <= 11 && !this.view.state.selection.empty) {
        ...
        if (
          e.focusNode &&
          nt(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset)
        )
  ...
  ignoreSelectionChange(e) {
    ...
    let t = /* @__PURE__ */ new Set(),
      r;
    for (let s = e.focusNode; s; s = $t(s)) t.add(s);
  ...
  flush() {
    ...
    a.eq(T.near(e.state.doc.resolve(0), 1))
      ? ((e.input.lastFocus = 0),
        ...
        e.scrollToSelection())
      : (s > -1 || o) &&
        (s > -1 && (e.docView.markDirty(s, i), _u(e)),
  ...
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      let i = o && o.parentNode == e.target ? K(o) + 1 : 0,
        l = r.localPosFromDOM(e.target, i, -1),
        c = s && s.parentNode == e.target ? K(s) : e.target.childNodes.length,
...
function _u(n) {
  if (
    ...
    if (((n.requiresGeckoHackNode = he), gs)) return;
    console.warn(
...
function Du(n) {
  ...
  return (
    nt(l.node, l.offset, s, i) && ([r, o, s, i] = [s, i, r, o]),
...
function Eu(n, e, t) {
  ...
  if (
    (u &&
      ...
      Nn(c) || a.push({ node: c.focusNode, offset: c.focusOffset })),
    W && n.input.lastKeyCode === 8)
  )
    for (let g = s; g > o; g--) {
  ...
  let f = n.state.doc,
    h = n.someProp("domParser") || gt.fromSchema(n.state.schema),
    p = f.resolve(i),
    d = null,
    m = h.parse(r, {
      topNode: p.parent,
...
function Au(n) {
  ...
  if (n.nodeName == "BR" && n.parentNode) {
    if (Z && /^(ul|ol)$/i.test(n.parentNode.nodeName)) {
      ...
      (Z && /^(tr|table)$/i.test(n.parentNode.nodeName))
    )
      return { ignore: !0 };
...
function Tu(n, e, t, r, o) {
  ...
  if (((n.input.compositionPendingChanges = 0), e < 0)) {
    ...
    if (M && !n.state.selection.eq(M)) {
      if (
        ...
        n.someProp("handleKeyDown", (Ee) => Ee(n, We(13, "Enter")))
      )
        return;
      let G = n.state.tr.setSelection(M);
      D == "pointer"
        ? G.setMeta("pointer", !0)
        : D == "key" && G.scrollIntoView(),
        s && G.setMeta("composition", s),
        n.dispatch(G);
    }
    return;
  }
  ...
  if (
    ((yt && n.input.lastIOSEnter > Date.now() - 225) || ue) &&
    o.some((D) => D.nodeType == 1 && !Mu.test(D.nodeName)) &&
    (!d || d.endA >= d.endB) &&
    n.someProp("handleKeyDown", (D) => D(n, We(13, "Enter")))
  ) {
    n.input.lastIOSEnter = 0;
    return;
  }
  ...
  let m = a.doc.resolveNoCache(d.start - a.from),
    ...
    b = u.resolve(d.start),
    y = m.sameParent(g) && m.parent.inlineContent && b.end() >= d.endA,
    S;
  if (
    ((yt &&
      n.input.lastIOSEnter > Date.now() - 225 &&
      (!y || o.some((D) => D.nodeName == "DIV" || D.nodeName == "P"))) ||
      (!y &&
  ...
  if (
    ...
    Nu(u, d.start, d.endA, m, g) &&
    n.someProp("handleKeyDown", (D) => D(n, We(8, "Backspace")))
  ) {
    ue && W && n.domObserver.suppressSelectionUpdates();
    return;
  }
  W && ue && d.endB == d.start && (n.input.lastAndroidDelete = Date.now()),
    ue &&
      !y &&
      m.start() != g.start() &&
      g.parentOffset == 0 &&
  ...
  if (y) {
    if (m.pos == g.pos)
      ee &&
        ze <= 11 &&
        m.parentOffset == 0 &&
        (n.domObserver.suppressSelectionUpdates(), setTimeout(() => De(n), 20)),
        (x = n.state.tr.delete(E, A)),
    ...
    D &&
      !(
        (W &&
          ...
          n.composing &&
          D.empty &&
          (d.start != d.endB || n.input.lastAndroidDelete < Date.now() - 100) &&
          (D.head == E || D.head == x.mapping.map(A) - 1)) ||
        (ee && D.empty && D.head == E)
      ) &&
      x.setSelection(D);
  }
...
function bs(n, e, t) {
  return Math.max(t.anchor, t.head) > e.content.size
    ? null
    : oo(n, e.resolve(t.anchor), e.resolve(t.head));
}
function Ou(n, e) {
  ...
  if (k.from(a).eq(n)) return { mark: l, type: i };
}
function Nu(n, e, t, r, o) {
  if (
    !r.parent.isTextblock || // The content must have shrunk
  ...
  return !i.parent.isTextblock || i.pos > t || sr(i, !0, !1) < t
    ? !1
...
function qu(n, e, t, r, o) {
  ...
  if (i < s && n.size < e.size) {
    let c = r <= s && r >= i ? s - r : 0;
    (s -= c),
      s && s < e.size && ks(e.textBetween(s - 1, s + 1)) && (s += c ? 1 : -1),
      (l = s + (l - i)),
      (i = s);
  } else if (l < s) {
    let c = r <= s && r >= l ? s - r : 0;
    (s -= c),
      s && s < n.size && ks(n.textBetween(s - 1, s + 1)) && (s += c ? 1 : -1),
      (i = s + (i - l)),
      (l = s);
  }
...
class Ru {
  ...
  */
  constructor(e, t) {
    (this._root = null),
      ...
      (this.editable = ws(this)),
      xs(this),
      (this.nodeViews = Cs(this)),
      (this.docView = Xo(this.state.doc, ys(this), or(this), this.dom, this)),
      (this.domObserver = new Su(this, (r, o, s, i) => Tu(this, r, o, s, i))),
  ...
  */
  update(e) {
    ...
    let t = this._props;
    (this._props = e),
      e.plugins && (e.plugins.forEach(vs), (this.directPlugins = e.plugins)),
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    (l || t.handleDOMEvents != this._props.handleDOMEvents) && Pr(this),
      (this.editable = ws(this)),
      xs(this);
    let c = or(this),
      a = ys(this),
    ...
    let h =
      u == "preserve" && i && this.dom.style.overflowAnchor == null && ga(this);
    if (i) {
      ...
      if (f) {
        ...
        (s || !this.docView.update(e.doc, a, c, this)) &&
          ...
          (this.docView = Xo(e.doc, a, c, this.dom, this))),
      ...
      !(
        ...
        ? De(this, p)
        : (al(this, e.selection), this.domObserver.setCurSelection()),
        this.domObserver.start();
    }
  ...
  */
  scrollToSelection() {
    ...
    if (!this.someProp("handleScrollToSelection", (t) => t(this)))
      ...
      } else Jo(this, this.coordsAtPos(this.state.selection.head, 1), e);
  }
  destroyPluginViews() {
    let e;
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Sl(
      e.slice,
      e.move,
      o < 0 ? void 0 : _.create(this.state.doc, o),
    );
  }
  someProp(e, t) {
  ...
  */
  destroy() {
    this.docView &&
      ...
      this.mounted
        ? (this.docView.update(this.state.doc, [], or(this), this),
  ...
  */
  domSelectionRange() {
    return Z &&
      ...
      aa(this.dom.ownerDocument) == this.dom
      ? Du(this)
      : this.domSelection();
  }
  /**
...
function re() {
  ...
  for (; e < arguments.length; e++) Ml(n, arguments[e]);
  return n;
}
function Ml(n, e) {
  if (typeof e == "string") n.appendChild(document.createTextNode(e));
    ...
    else if (Array.isArray(e)) for (var t = 0; t < e.length; t++) Ml(n, e[t]);
...
const Lu = (n, e, t) => {
  ...
  let s = o.nodeBefore;
  if (!s.type.spec.isolating && Rl(n, o, e)) return !0;
      ...
      if (e) {
        ...
        l.setSelection(
          xt(s, "end")
            ...
            : _.create(l.doc, o.pos - s.nodeSize),
        ),
          e(l.scrollIntoView());
      }
      return !0;
...
const Bu = (n, e, t) => {
  ...
  return !i || !_.isSelectable(i)
    ...
    : (e &&
        e(
          n.tr
            .setSelection(_.create(n.doc, s.pos - i.nodeSize))
            .scrollIntoView(),
        ),
      !0);
};
...
const Vu = (n, e, t) => {
        ...
        if (e) {
          ...
          l.setSelection(
            xt(s, "start")
              ...
              : _.create(l.doc, l.mapping.map(o.pos)),
          ),
            e(l.scrollIntoView());
        }
        return !0;
  ...
  $u = (n, e, t) => {
    ...
    return !i || !_.isSelectable(i)
      ? !1
      : (e && e(n.tr.setSelection(_.create(n.doc, s.pos)).scrollIntoView()),
        !0);
  };
function Nl(n) {
  if (!n.parent.type.spec.isolating)
...
const Vr = (n, e) => {
    let t = n.selection,
      ...
      o;
    if (r) {
      if (t.node.isTextblock || !wt(n.doc, t.from)) return !1;
      o = t.from;
    } else if (((o = Vi(n.doc, t.from, -1)), o == null)) return !1;
    if (e) {
      let s = n.tr.join(o);
      r &&
        s.setSelection(
          _.create(s.doc, o - n.doc.resolve(o).nodeBefore.nodeSize),
        ),
        e(s.scrollIntoView());
    }
    return !0;
  ...
  Uu = (n, e) => {
    let t = n.selection,
      r;
    if (t instanceof _) {
      if (t.node.isTextblock || !wt(n.doc, t.to)) return !1;
      r = t.to;
    } else if (((r = Vi(n.doc, t.to, 1)), r == null)) return !1;
...
const ql = (n, e) => {
  ...
  ju = (n, e) => {
    ...
    if (e) {
      let i = (!r.parentOffset && o.index() < o.parent.childCount ? r : o).pos,
  ...
  Wu = (n, e) => {
    ...
    if (t.depth > 1 && t.after() != t.end(-1)) {
      let s = t.before();
      if (pt(n.doc, s)) return e && e(n.tr.split(s).scrollIntoView()), !0;
    }
    let r = t.blockRange(),
      o = r && Kt(r);
...
function Ju(n) {
  return (e, t) => {
    ...
    if (e.selection instanceof _ && e.selection.node.isBlock)
      return !r.parentOffset || !pt(e.doc, r.pos)
        ? !1
    ...
    if (t) {
      ...
      (e.selection instanceof I || e.selection instanceof ne) &&
        i.deleteSelection();
      let l =
          r.depth == 0 ? null : uo(r.node(-1).contentMatchAt(r.indexAfter(-1))),
        c = n && n(o.parent, s),
        a = c ? [c] : s && l ? [{ type: l }] : void 0,
        u = pt(i.doc, i.mapping.map(r.pos), 1, a);
      if (
        (!a &&
          !u &&
          pt(i.doc, i.mapping.map(r.pos), 1, l ? [{ type: l }] : void 0) &&
          (l && (a = [{ type: l }]), (u = !0)),
        u &&
...
const Gu = Ju(),
  Ur = (n, e) => {
    ...
    return s == 0
      ? !1
      : ((o = t.before(s)), e && e(n.tr.setSelection(_.create(n.doc, o))), !0);
  },
...
function Zu(n, e, t) {
  ...
  return !r || !o || !r.type.compatibleContent(o.type)
    ...
    : !r.content.size && e.parent.canReplace(s - 1, s)
      ...
      : !e.parent.canReplace(s, s + 1) || !(o.isTextblock || wt(n.doc, e.pos))
        ? !1
        : (t &&
            t(
              n.tr
...
function Rl(n, e, t) {
  ...
  if (
    ...
    if (t) {
      let f = e.pos + o.nodeSize,
        h = k.empty;
      for (let m = s.length - 1; m >= 0; m--) h = k.from(s[m].create(null, h));
      h = k.from(r.copy(h));
      let p = n.tr.step(
          new U(e.pos - 1, f, e.pos, f, new C(h, 1, 0), s.length, !0),
        ),
        d = f + 2 * s.length;
  ...
  if (l && xt(o, "start", !0) && xt(r, "end")) {
    ...
    if (f.canReplace(f.childCount, f.childCount, p.content)) {
      if (t) {
        let m = k.empty;
        for (let b = h.length - 1; b >= 0; b--) m = k.from(h[b].copy(m));
        let g = n.tr.step(
          new U(
            e.pos - h.length,
            e.pos + o.nodeSize,
...
function Il(n) {
  return function (e, t) {
    ...
    return o.node(s).isTextblock
      ? (t &&
          t(e.tr.setSelection(I.create(e.doc, n < 0 ? o.start(s) : o.end(s)))),
        !0)
      : !1;
  };
}
...
P.prototype.append = function (e) {
  return e.length
    ? ((e = P.from(e)),
      (!this.length && e) ||
        (e.length < _n && this.leafAppend(e)) ||
        (this.length < _n && e.leafPrepend(this)) ||
        this.appendInner(e))
    : this;
};
...
P.prototype.slice = function (e, t) {
  return (
    ...
    e >= t ? P.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, t))
  );
};
...
class fe {
        ...
        (f, h) => {
          ...
          if (o) {
            ...
            p &&
              ...
              a.push(new me(d, void 0, void 0, a.length + u.length))),
              s--,
              d && o.appendMap(d, s);
  ...
  addMaps(e) {
    return this.eventCount == 0
      ? this
      : new fe(this.items.append(e.map((t) => new me(t))), this.eventCount);
  }
  ...
  rebased(e, t) {
    ...
    this.items.forEach((h) => {
      ...
      } else r.push(new me(d));
    }, o);
    let a = [];
    for (let h = t; h < i; h++) a.push(new me(s.maps[h]));
    let u = this.items.slice(0, o).append(a).append(r),
      f = new fe(u, l);
    return (
      f.emptyItemCount() > rf && (f = f.compress(this.items.length - r.length)),
      f
    );
  }
  emptyItemCount() {
...
class me {
  ...
  merge(e) {
    if (this.step && e.step && !e.selection) {
      ...
      if (t) return new me(t.getMap().invert(), t, this.selection);
    }
  }
}
class Oe {
...
function lf(n, e, t, r) {
  ...
  if (i && i.getMeta(Pe))
    return i.getMeta(Pe).redo
      ? new Oe(
          n.done.addTransform(t, void 0, r, pn(e)),
          n.undone,
          _s(t.mapping.maps[t.steps.length - 1]),
          n.prevTime,
          n.prevComposition,
        )
      : new Oe(
          n.done,
          n.undone.addTransform(t, void 0, r, pn(e)),
          null,
          n.prevTime,
          n.prevComposition,
        );
      ...
      c =
        ...
        (!i &&
          ...
          (n.prevTime < (t.time || 0) - r.newGroupDelay ||
            !cf(t, n.prevRanges))),
      a = i
        ? lr(n.prevRanges, t.mapping)
        : _s(t.mapping.maps[t.steps.length - 1]);
    return new Oe(
      n.done.addTransform(t, c ? e.selection.getBookmark() : void 0, r, pn(e)),
      fe.empty,
      a,
      t.time,
      l ?? n.prevComposition,
...
function Ll(n, e, t, r) {
  ...
  let l = i.selection.resolve(i.transform.doc),
    ...
    a = new Oe(r ? c : i.remaining, r ? i.remaining : c, null, 0, -1);
  t(
    i.transform
      .setSelection(l)
...
const Pe = new Ki("history"),
  af = new Ki("closeHistory");
function uf(n = {}) {
  return (
    (n = {
      depth: n.depth || 100,
    ...
    new $e({
      ...
      props: {
        handleDOMEvents: {
          beforeinput(e, t) {
            let r = t.inputType,
              o = r == "historyUndo" ? Dn : r == "historyRedo" ? Wt : null;
...
function pf(n, e) {
  ...
  if (((r.className = jr), e.path)) {
    ...
    (c.style.width = s / i + "em"),
      c
        .appendChild(t.createElementNS(It, "use"))
        .setAttributeNS(
          ff,
          "href",
...
function df(n, e, t) {
  let [r, o] = n.nodeType == 9 ? [n, n.body] : [n.ownerDocument || document, n],
    s = r.getElementById(jr + "-collection");
  s ||
    ((s = r.createElementNS(It, "svg")),
    (s.id = jr + "-collection"),
  ...
  (i.id = e),
    ...
    i.appendChild(r.createElementNS(It, "path")).setAttribute("d", t.path),
    s.appendChild(i);
}
  ...
  render(e) {
    ...
    t.class && r.classList.add(t.class),
      ...
      r.addEventListener("mousedown", (s) => {
        s.preventDefault(),
          r.classList.contains(X + "-disabled") ||
    ...
    function o(s) {
      ...
      let i = !0;
      if (
        (t.enable && ((i = t.enable(s) || !1), Wr(r, X + "-disabled", !i)),
        t.active)
      ) {
...
class Es {
  ...
  */
  render(e) {
    ...
    let s = re("div", { class: X + "-dropdown-wrap" }, o),
      i = null,
      l = null,
      c = () => {
  ...
  */
  expand(e, t) {
    let r = re(
        "div",
        { class: X + "-dropdown-menu " + (this.options.class || "") },
        t,
      ),
      o = !1;
    function s() {
  ...
  */
  render(e) {
    let t = Vl(this.content, e),
      ...
      o = re(
        "div",
        { class: X + "-submenu-label" },
        Jt(e, this.options.label || ""),
      ),
      s = re(
        "div",
        { class: X + "-submenu-wrap" },
        o,
        re("div", { class: X + "-submenu" }, t.dom),
      ),
      i = null;
    o.addEventListener("mousedown", (c) => {
      c.preventDefault(),
        Bl(c),
        Wr(s, X + "-submenu-wrap-active", !1),
        i ||
          r.addEventListener(
            "mousedown",
            (i = () => {
              Pl(s) ||
                (s.classList.remove(X + "-submenu-wrap-active"),
  ...
  for (let i = 0; i < e.length; i++) {
    ...
    for (let u = 0; u < l.length; u++) {
      let { dom: f, update: h } = l[u].render(n),
        p = re("span", { class: X + "item" }, f);
      t.appendChild(p), a.push(p), c.push(h);
    }
    c.length &&
      (r.push($l(c, a)), i < e.length - 1 && o.push(t.appendChild(bf())));
  }
  function s(i) {
    let l = !1,
      c = !1;
...
class _f {
  constructor(e, t) {
    (this.editorView = e),
      ...
      (this.wrapper = re("div", { class: on + "-wrapper" })),
      (this.menu = this.wrapper.appendChild(re("div", { class: on }))),
      (this.menu.className = on),
    ...
    if (
      ...
      (this.scrollHandler = (i) => {
        ...
        (l.body || l).contains(this.wrapper)
          ? this.updateFloat(i.target.getBoundingClientRect ? i.target : void 0)
          : s.forEach((c) =>
...
function st(n, e, t = null, r) {
  return new He(n, (o, s, i, l) => {
    ...
    return (
      p && p.type == e && wt(a.doc, i - 1) && (!r || r(s, p)) && a.join(i - 1),
      a
    );
  });
}
...
function zn(n, e, t) {
  var r,
    ...
    c = "";
  for (
    typeof e != "string" && ((t = e), (e = zn.defaultChars)),
      typeof t > "u" && (t = !0),
      l = M9(e),
      r = 0,
      o = n.length;
...
function Ln(n, e) {
  var t;
  return (
    typeof e != "string" && (e = Ln.defaultChars),
    (t = O9(e)),
...
En.prototype.parse = function (n, e) {
  ...
  if (
    ...
    (e || a || l.match(/^\/\/[^@\/]+@[^@\/]+/)) &&
      ((i = l.substr(0, 2) === "//"),
      i && !(a && Rs[a]) && ((l = l.substr(2)), (this.slashes = !0))),
    !Rs[a] && (i || (a && !Is[a])))
  ) {
    var u = -1;
    ...
    this.hostname.length > P9 && (this.hostname = ""),
  ...
  return (
    ...
    l && (this.pathname = l),
    Is[o] && this.hostname && !this.pathname && (this.pathname = ""),
    this
  );
};
  ...
  function s(w) {
    ...
    return (
      q.forEach(function (v) {
        if (v) {
          if (typeof v != "object") throw new TypeError(v + "must be object");
  ...
  J9 = function (e, t, r) {
    ...
    if (e.charCodeAt(i) === 60) {
      for (i++; i < r; ) {
        ...
        if (o === 62)
          return (
            (l.pos = i + 1), (l.str = Vs(e.slice(t + 1, i))), (l.ok = !0), l
          );
        if (o === 92 && i + 1 < r) {
          i += 2;
          continue;
    ...
    return (
      t === i ||
        s !== 0 ||
        ((l.str = Vs(e.slice(t, i))), (l.pos = i), (l.ok = !0)),
      l
    );
  },
  G9 = R.unescapeAll,
...
xe.image = function (n, e, t, r, o) {
  var s = n[e];
  return (
    (s.attrs[s.attrIndex("alt")][1] = o.renderInlineAsText(s.children, t, r)),
    o.renderToken(n, e, t)
  );
};
      ...
      for (r = 0, o = y.length; r < o; r++)
        if (!(y[r].type !== "inline" || !e.md.linkify.pretest(y[r].content)))
          for (s = y[r].children, d = 0, t = s.length - 1; t >= 0; t--) {
            ...
            if (
              (l.type === "html_inline" &&
                (s7(l.content) && d > 0 && d--, i7(l.content) && d++),
...
function h7(n) {
  ...
  for (e = n.length - 1; e >= 0; e--)
    (t = n[e]),
      t.type === "text" && !r && (t.content = t.content.replace(a7, f7)),
    ...
    if (e.md.options.typographer)
      for (t = e.tokens.length - 1; t >= 0; t--)
        e.tokens[t].type === "inline" &&
          (c7.test(e.tokens[t].content) && h7(e.tokens[t].children),
          ec.test(e.tokens[t].content) && p7(e.tokens[t].children));
  },
  $s = R.isWhiteSpace,
  Us = R.isPunctChar,
  Hs = R.isMdAsciiPunct,
...
function g7(n, e) {
  ...
  for (E = [], t = 0; t < n.length; t++) {
    for (
      r = n[t], c = n[t].level, y = E.length - 1;
      y >= 0 && !(E[y].level <= c);
      y--
    );
    if (((E.length = y + 1), r.type === "text")) {
      (o = r.content), (i = 0), (l = o.length);
      e: for (; i < l && ((js.lastIndex = i), (s = js.exec(o)), !!s); ) {
        if (
          ((g = b = !0),
          (i = s.index + 1),
          (S = s[0] === "'"),
          ...
          for (
            y = t - 1;
            y >= 0 && !(n[y].type === "softbreak" || n[y].type === "hardbreak");
            y--
          )
            if (n[y].content) {
        ...
        if (((f = 32), i < l)) f = o.charCodeAt(i);
          ...
          for (
            y = t + 1;
            y < n.length &&
            !(n[y].type === "softbreak" || n[y].type === "hardbreak");
            y++
          )
            if (n[y].content) {
        ...
        if (
          ((h = Hs(u) || Us(String.fromCharCode(u))),
          (p = Hs(f) || Us(String.fromCharCode(f))),
          (d = $s(u)),
          (m = $s(f)),
          m ? (g = !1) : p && (d || h || (g = !1)),
          d ? (b = !1) : h && (m || p || (b = !1)),
        ...
        if (b) {
          for (y = E.length - 1; y >= 0 && ((a = E[y]), !(E[y].level < c)); y--)
            if (a.single === S && E[y].level === c) {
              (a = E[y]),
                S
                  ? ((A = e.md.options.quotes[2]), (x = e.md.options.quotes[3]))
                  : ((A = e.md.options.quotes[0]),
                    (x = e.md.options.quotes[1])),
                (r.content = sn(r.content, s.index, x)),
                (n[a.token].content = sn(n[a.token].content, a.pos, A)),
                (i += x.length - 1),
                a.token === t && (i += A.length - 1),
                (o = r.content),
                (l = o.length),
                (E.length = y);
              continue e;
...
var b7 = function (e) {
    ...
    if (e.md.options.typographer)
      for (t = e.tokens.length - 1; t >= 0; t--)
        e.tokens[t].type !== "inline" ||
          !m7.test(e.tokens[t].content) ||
          g7(e.tokens[t].children, e);
  },
  k7 = function (e) {
    var t,
      r,
...
function wo() {
  this.ruler = new w7();
  for (var n = 0; n < pr.length; n++) this.ruler.push(pr[n][0], pr[n][1]);
}
...
var v7 = function (e, t, r, o) {
    ...
    if (
      ...
      ((A = e.src.charCodeAt(l++)), A !== 124 && A !== 45 && A !== 58) ||
      l >= e.eMarks[u] ||
      ((x = e.src.charCodeAt(l++)),
      x !== 124 && x !== 45 && x !== 58 && !dr(x)) ||
      (A === 45 && dr(x))
    )
      return !1;
    for (; l < e.eMarks[u]; ) {
      if (
        ((s = e.src.charCodeAt(l)), s !== 124 && s !== 45 && s !== 58 && !dr(s))
      )
        return !1;
      l++;
    }
    ...
    for (
      y = e.parentType,
        e.parentType = "table",
        E = e.md.block.ruler.getRules("blockquote"),
    ...
    for (
      ...
      for (
        f = Js(i),
          ...
          f.length && f[f.length - 1] === "" && f.pop(),
          u === t + 2 &&
            ((p = e.push("tbody_open", "tbody", 1)), (p.map = b = [t + 2, 0])),
          p = e.push("tr_open", "tr", 1),
          p.map = [u, u + 1],
          c = 0;
        c < h;
...
`),
  ...
  E7 = function (e, t, r, o) {
    ...
    for (
      ...
      if (e.src.charCodeAt(M++) === 62 && !F) {
        ...
        (u = M >= G),
          m.push(e.bsCount[h]),
          (e.bsCount[h] = e.sCount[h] + 1 + (E ? 1 : 0)),
          y.push(e.sCount[h]),
          (e.sCount[h] = p - c),
          S.push(e.tShift[h]),
  ...
  M7 = function (e, t, r, o) {
    ...
    if (
      ...
      return !1;
    for (i = 1; a < u; ) {
      if (((l = e.src.charCodeAt(a++)), l !== s && !A7(l))) return !1;
      l === s && i++;
    }
    return i < 3
      ? !1
...
function Ks(n, e) {
  var t,
    ...
    o = r,
    s = n.eMarks[e];
  if (o + 1 >= s || ((t = n.src.charCodeAt(o++)), t < 48 || t > 57)) return -1;
  for (;;) {
    if (o >= s) return -1;
...
var O7 = function (e, t, r, o) {
    var s,
      ...
      Eo = !0;
    if (
      e.sCount[v] - e.blkIndent >= 4 ||
      (e.listIndent >= 0 &&
        e.sCount[v] - e.listIndent >= 4 &&
    ...
    if (
      ...
      if (
        ...
        (b = Number(e.src.slice(Ee, M - 1))),
        Ae && b !== 1)
      )
        return !1;
    } else if ((M = Gs(e, v)) >= 0) f = !1;
    else return !1;
    if (Ae && e.skipSpaces(M) >= e.eMarks[v]) return !1;
    if (o) return !0;
    for (
      g = e.src.charCodeAt(M - 1),
        m = e.tokens.length,
        f
          ? ((q = e.push("ordered_list_open", "ol", 1)),
            b !== 1 && (q.attrs = [["start", b]]))
          : (q = e.push("bullet_list_open", "ul", 1)),
        q.map = d = [v, 0],
        q.markup = String.fromCharCode(g),
        G = !1,
      ...
      for (
        D = M,
          y = e.eMarks[v],
          u = S = e.sCount[v] + M - (e.bMarks[v] + e.tShift[v]);
        D < y;
      ...
      if (
        ...
        a > 4 && (a = 1),
        (c = u + a),
        (q = e.push("list_item_open", "li", 1)),
        (q.markup = String.fromCharCode(g)),
        (q.map = h = [v, 0]),
        f && (q.info = e.src.slice(Ee, M - 1)),
        (F = e.tight),
        (N = e.tShift[v]),
        (x = e.sCount[v]),
        (E = e.listIndent),
        ...
        (e.blkIndent = c),
        (e.tight = !0),
        (e.tShift[v] = i - e.bMarks[v]),
        (e.sCount[v] = S),
        i >= y && e.isEmpty(v + 1)
          ? (e.line = Math.min(e.line + 2, r))
          : e.md.block.tokenize(e, v, r, !0),
        (!e.tight || G) && (Eo = !1),
        (G = e.line - v > 1 && e.isEmpty(e.line - 1)),
        (e.blkIndent = e.listIndent),
        (e.listIndent = E),
        (e.tShift[v] = N),
        (e.sCount[v] = x),
        (e.tight = F),
        (q = e.push("list_item_close", "li", -1)),
        (q.markup = String.fromCharCode(g)),
        (v = e.line),
        (h[1] = v),
        v >= r || e.sCount[v] < e.blkIndent || e.sCount[v] - e.blkIndent >= 4)
      )
        break;
      ...
      if (_t) break;
      if (f) {
        if (((M = Ks(e, v)), M < 0)) break;
        Ee = e.bMarks[v] + e.tShift[v];
      } else if (((M = Gs(e, v)), M < 0)) break;
      if (g !== e.src.charCodeAt(M - 1)) break;
    }
    return (
      f
        ? (q = e.push("ordered_list_close", "ol", -1))
        : (q = e.push("bullet_list_close", "ul", -1)),
      (q.markup = String.fromCharCode(g)),
      (d[1] = v),
      (e.line = v),
      (e.parentType = A),
  ...
  q7 = function (e, t, r, o) {
    var s,
      ...
      N = e.eMarks[t],
      F = t + 1;
    if (e.sCount[t] - e.blkIndent >= 4 || e.src.charCodeAt(x) !== 91) return !1;
    for (; ++x < N; )
    ...
    for (
      b = e.getLines(t, F, e.blkIndent, !1).trim(), N = b.length, x = 1;
      x < N;
      x++
    ) {
      ...
      if (s === 93) {
        ...
        s === 10
          ? A++
          : s === 92 && (x++, x < N && b.charCodeAt(x) === 10 && A++);
    }
    if (p < 0 || b.charCodeAt(p + 1) !== 58) return !1;
    for (x = p + 2; x < N; x++)
      if (((s = b.charCodeAt(x)), s === 10)) A++;
      else if (!ln(s)) break;
    if (
    ...
    for (
      m = e.md.helpers.parseLinkTitle(b, x, N),
        x < N && g !== x && m.ok
          ? ((E = m.str), (x = m.pos), (A += m.lines))
          : ((E = ""), (x = i), (A = l));
      x < N && ((s = b.charCodeAt(x)), !!ln(s));
    ...
    if (x < N && b.charCodeAt(x) !== 10 && E)
      for (E = "", x = i, A = l; x < N && ((s = b.charCodeAt(x)), !!ln(s)); )
        x++;
    return (x < N && b.charCodeAt(x) !== 10) || ((h = N7(b.slice(1, p))), !h)
      ? !1
      : (o ||
          (typeof e.env.references > "u" && (e.env.references = {}),
          typeof e.env.references[h] > "u" &&
            (e.env.references[h] = { title: E, href: a }),
          (e.parentType = d),
          (e.line = t + A + 1)),
        !0);
  },
  ...
  Pn = {},
  I7 = "[a-zA-Z_:][a-zA-Z0-9:._-]*",
  F7 = "[^\"'=<>`\\x00-\\x20]+",
  z7 = "'[^']*'",
  L7 = '"[^"]*"',
  B7 = "(?:" + F7 + "|" + z7 + "|" + L7 + ")",
  P7 = "(?:\\s+" + I7 + "(?:\\s*=\\s*" + B7 + ")?)",
  rc = "<[A-Za-z][A-Za-z0-9\\-]*" + P7 + "*\\s*\\/?>",
  oc = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>",
  V7 = "<!---->|<!--(?:-?[^>-])(?:-?[^-])*-->",
  $7 = "<[?][\\s\\S]*?[?]>",
  U7 = "<![A-Z]+\\s+[^>]*>",
  H7 = "<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",
  ...
  Z7 = function (e, t, r, o) {
    ...
    return i > 6 || (a < u && !Zs(s))
      ...
      : (o ||
          ...
          l > a && Zs(e.src.charCodeAt(l - 1)) && (u = l),
          (e.line = t + 1),
...
we.prototype.skipSpaces = function (e) {
  for (
    ...
    e < r && ((t = this.src.charCodeAt(e)), !!Vn(t));
    e++
  );
  return e;
};
we.prototype.skipSpacesBack = function (e, t) {
  if (e <= t) return e;
  for (; e > t; ) if (!Vn(this.src.charCodeAt(--e))) return e + 1;
  return e;
};
...
var rU = function (e, t) {
    for (var r = e.pos; r < e.posMax && !nU(e.src.charCodeAt(r)); ) r++;
    return r === e.pos
      ? !1
      : (t || (e.pending += e.src.slice(e.pos, r)), (e.pos = r), !0);
  },
  oU = /(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i,
  sU = function (e, t) {
    var r, o, s, i, l, c, a, u;
  ...
  lU = function (e, t) {
    ...
    for (i++; i < o && iU(e.src.charCodeAt(i)); ) i++;
    return (e.pos = i), !0;
  },
  cU = R.isSpace,
  Co = [];
for (var Ys = 0; Ys < 256; Ys++) Co.push(0);
...
var aU = function (e, t) {
    ...
    return (
      ...
      t ||
        ...
        r < 256 && Co[r] !== 0 ? (l.content = i) : (l.content = s),
        (l.markup = s),
        (l.info = "escape")),
      (e.pos = c + 1),
      !0
  ...
  for (t = c - 1; t >= 0; t--)
    (r = e[t]),
      !(r.marker !== 95 && r.marker !== 42) &&
        ...
        (l =
          t > 0 &&
          e[t - 1].end === r.end + 1 && // check that first two markers match and adjacent
          e[t - 1].marker === r.marker &&
          e[t - 1].token === r.token - 1 && // check that last two markers are adjacent (we can safely assume they match)
...
var fU = R.normalizeReference,
  ...
  hU = function (e, t) {
    ...
    if (
      ...
      ((l = e.pos + 1), (i = e.md.helpers.parseLinkLabel(e, e.pos, !0)), i < 0)
    )
      return !1;
    if (((c = i + 1), c < m && e.src.charCodeAt(c) === 40)) {
      for (
        b = !1, c++;
        c < m && ((o = e.src.charCodeAt(c)), !(!gr(o) && o !== 10));
        c++
      );
      if (c >= m) return !1;
      if (
  ...
  dU = function (e, t) {
    ...
    if (((a = l + 1), a < y && e.src.charCodeAt(a) === 40)) {
      for (
        a++;
        a < y && ((o = e.src.charCodeAt(a)), !(!br(o) && o !== 10));
        a++
      );
      if (a >= y) return !1;
      for (
      ...
      if (a >= y || e.src.charCodeAt(a) !== 41) return (e.pos = b), !1;
      a++;
    } else {
      if (typeof e.env.references > "u") return !1;
      if (
        (a < y && e.src.charCodeAt(a) === 91
          ? ((m = a + 1),
            (a = e.md.helpers.parseLinkLabel(e, a)),
            a >= 0 ? (i = e.src.slice(m, a++)) : (a = l + 1))
          : (a = l + 1),
        i || (i = e.src.slice(c, l)),
        (u = e.env.references[pU(i)]),
        !u)
      )
        return (e.pos = b), !1;
      (g = u.href), (h = u.title);
  ...
  gU = /^([a-zA-Z][a-zA-Z0-9+.\-]{1,31}):([^<>\x00-\x20]*)$/,
  bU = function (e, t) {
    var r,
      o,
      s,
...
var CU = function (e, t) {
    ...
    return !e.md.options.html ||
      ...
      r !== 33 && r !== 63 && r !== 47 && !wU(r)) ||
      ((o = e.src.slice(l).match(kU)), !o)
      ? !1
      : (t ||
          ((i = e.push("html_inline", "", 0)),
          (i.content = o[0]),
          yU(i.content) && e.linkLevel++,
          xU(i.content) && e.linkLevel--),
        (e.pos += o[0].length),
        !0);
  },
  ei = Zl,
  vU = R.has,
  SU = R.isValidEntityCode,
  ti = R.fromCodePoint,
  _U = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,
  DU = /^&([a-z][a-z0-9]{1,31});/i,
  EU = function (e, t) {
    var r,
      o,
      s,
...
Xt.prototype.scanDelims = function (n, e) {
  ...
  return (
    ...
    (a = si(r) || oi(String.fromCharCode(r))),
    (f = si(o) || oi(String.fromCharCode(o))),
    (c = ri(r)),
    (u = ri(o)),
    u ? (h = !1) : f && (c || a || (h = !1)),
    c ? (p = !1) : a && (u || f || (p = !1)),
...
function An(n) {
  var e = (n.re = NU()(n.__opts__)),
    t = n.__tlds__.slice();
  n.onCompile(),
    n.__tlds_replaced__ || t.push(BU),
    t.push(e.src_xn),
    (e.src_tlds = t.join("|"));
  function r(l) {
...
function oe(n, e) {
  ...
  e || (zU(n) && ((e = n), (n = {}))),
    (this.__opts__ = Jr({}, ic, e)),
    (this.__index__ = -1),
    (this.__last_index__ = -1),
    (this.__schema__ = ""),
    (this.__text_cache__ = ""),
    (this.__schemas__ = Jr({}, LU, n)),
    (this.__compiled__ = {}),
    (this.__tlds__ = PU),
...
oe.prototype.match = function (e) {
  ...
  this.__index__ >= 0 &&
    ...
    (r.push(Gr(this, t)), (t = this.__last_index__));
...
var GU = {
  ...
  sH = /^data:image\/(gif|png|jpeg|webp);/;
function iH(n) {
...
function ae(n, e) {
  ...
  e || Lt.isString(n) || ((e = n || {}), (n = "default")),
    (this.inline = new tH()),
    (this.block = new eH()),
    (this.core = new XU()),
    (this.renderer = new QU()),
    (this.linkify = new nH()),
    (this.validateLink = iH),
    (this.normalizeLink = lH),
    (this.normalizeLinkText = cH),
    (this.utils = Lt),
    (this.helpers = Lt.assign({}, YU)),
    (this.options = {}),
    this.configure(n),
    e && this.set(e);
}
  ...
  return (
    ...
    n.components &&
      Object.keys(n.components).forEach(function (r) {
        n.components[r].rules && e[r].ruler.enableOnly(n.components[r].rules),
...
ae.prototype.renderInline = function (n, e) {
  return (
    (e = e || {}), this.renderer.render(this.parseInline(n, e), this.options, e)
  );
};
var aH = ae,
  uH = aH;
const fH = /* @__PURE__ */ ah(uH),
  So = new Ni({
    nodes: {
      doc: {
        content: "block+",
        ...
        parseDOM: [
          {
            ...
            getAttrs: (n) => ({ params: n.getAttribute("data-params") || "" }),
          },
        ],
        toDOM(n) {
          return [
...
class pH {
  constructor(e, t) {
    (this.schema = e),
      ...
      (this.stack = [
        { type: e.topNodeType, attrs: null, content: [], marks: O.none },
      ]);
  }
  top() {
...
function dH(n, e) {
  ...
  for (let r in e) {
    ...
    if (o.block) {
      ...
      wr(o, r)
        ? (t[r] = (i, l, c, a) => {
            i.openNode(s, Et(o, l, c, a)),
              i.addText(ui(l.content)),
              i.closeNode();
          })
        : ((t[r + "_open"] = (i, l, c, a) => i.openNode(s, Et(o, l, c, a))),
      ...
      wr(o, r)
        ? (t[r] = (i, l, c, a) => {
            i.openMark(s.create(Et(o, l, c, a))),
              i.addText(ui(l.content)),
              i.closeMark(s);
          })
        : ((t[r + "_open"] = (i, l, c, a) =>
...
class mH {
  ...
  */
  parse(e, t = {}) {
    let r = new pH(this.schema, this.tokenHandlers),
      o;
...
`);
  ...
  yH = /* @__PURE__ */ Object.assign({
    "./nodes/addresses.js": Hl,
    "./nodes/call_to_action.js": jl,
    "./nodes/contacts.js": Wl,
    "./nodes/example_callout.js": Jl,
    "./nodes/information_callout.js": Gl,
    "./nodes/warning_callout.js": Kl,
  }),
  xH = Object.values(yH),
  wH = Object.fromEntries(xH.map((n) => [n.name, n.toGovspeak])),
  CH = Object.assign(kH, wH),
  hi = new gH(CH, {
...
function vH(n, e, t) {
  ...
  let r = e.child(t);
  return !r.isText || r.text != n.attrs.href || r.marks[r.marks.length - 1] != n
    ? !1
...
function Kr(n, e = null) {
  return function (t, r) {
    ...
    if (
      ...
      (c = new bn(u, u, i.depth)),
        i.endIndex < i.parent.childCount &&
          (i = new bn(o, t.doc.resolve(s.end(i.depth)), i.depth)),
        (l = !0);
    }
    let a = Qr(c, n, e, i);
...
function OH(n, e, t, r, o) {
  ...
  for (let u = e.startIndex, f = e.endIndex, h = !0; u < f; u++, h = !1)
    !h && pt(n.doc, c, l) && (n.split(c, l), (c += 2 * l)),
    ...
    if (
      ...
      if (r) {
        ...
        let d = o.before(o.depth - (h - 1)),
          m = t.tr.replace(d, o.after(-p), new C(f, 4 - h, 0)),
          g = -1;
  ...
  s < i &&
    (o.step(
      new U(
        ...
        s,
        i,
        new C(k.from(t.create(null, r.parent.copy())), 1, 0),
        1,
        !0,
      ),
    ),
    (r = new bn(o.doc.resolve(r.$from.pos), o.doc.resolve(i), r.depth)));
  const l = Kt(r);
  if (l == null) return !1;
  o.lift(r, l);
...
function IH(n, e, t) {
  ...
  if (
    !a.canReplace(
      u + (l ? 0 : 1),
      u + 1,
      i.content.append(c ? k.empty : k.from(o)),
    )
  )
    return !1;
  let f = s.pos,
  ...
  return (
    r.step(
      new U(
        ...
        h - 1,
        new C(
          (l ? k.empty : k.from(o.copy(k.empty))).append(
            c ? k.empty : k.from(o.copy(k.empty)),
          ),
          l ? 0 : 1,
          c ? 0 : 1,
        ),
  ...
  return function (e, t) {
    ...
    if (t) {
      let a = c.lastChild && c.lastChild.type == l.type,
        u = k.from(a ? n.create() : null),
        f = new C(
          k.from(n.create(null, k.from(l.type.create(null, u)))),
          a ? 3 : 1,
          0,
        ),
        h = s.start,
...
const zH = /* @__PURE__ */ Object.assign({
    "./nodes/addresses.js": Hl,
    "./nodes/call_to_action.js": jl,
    "./nodes/contacts.js": Wl,
    "./nodes/example_callout.js": Jl,
...
var Ve = {
  ...
  BH = typeof navigator < "u" && /Mac/.test(navigator.platform),
  PH =
    typeof navigator < "u" &&
    /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var $ = 0; $ < 10; $++) Ve[48 + $] = Ve[96 + $] = String($);
for (var $ = 1; $ <= 24; $++) Ve[$ + 111] = "F" + $;
for (var $ = 65; $ <= 90; $++)
  (Ve[$] = String.fromCharCode($ + 32)), (Mn[$] = String.fromCharCode($));
for (var Sr in Ve) Mn.hasOwnProperty(Sr) || (Mn[Sr] = Ve[Sr]);
function VH(n) {
  var e =
      (BH && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey) ||
      (PH && n.shiftKey && n.key && n.key.length == 1) ||
      n.key == "Unidentified",
    t =
      (!e && n.key) ||
      (n.shiftKey ? Mn : Ve)[n.keyCode] ||
      n.key ||
      "Unidentified";
  return (
    t == "Esc" && (t = "Escape"),
...
function UH(n) {
  ...
  for (let l = 0; l < e.length - 1; l++) {
    ...
    else if (/^mod$/i.test(c)) $H ? (i = !0) : (o = !0);
...
class z extends T {
  ...
  */
  static valid(e) {
    let t = e.parent;
    if (t.isTextblock || !JH(e) || !GH(e)) return !1;
...
function KH() {
  return new $e({
    props: {
      ...
      handleClick: YH,
      handleKeyDown: ZH,
      handleDOMEvents: { beforeinput: QH },
    },
  });
}
const ZH = ac({
...
function YH(n, e, t) {
  ...
  return o && o.inside > -1 && _.isSelectable(n.state.doc.nodeAt(o.inside))
    ? !1
...
function hc(n, e) {
  ...
  for (let r in e) t[r] = e[r];
  return (
    !e.enable && !e.select && (t[e.enable ? "enable" : "select"] = (r) => n(r)),
    new pe(t)
  );
}
function Zr(n, e) {
...
function pc(n) {
  let e = {},
    t;
  (t = n.marks.strong) &&
    (e.toggleStrong = Dr(t, { title: "Toggle strong style", icon: ie.strong })),
    (t = n.marks.em) &&
      (e.toggleEm = Dr(t, { title: "Toggle emphasis", icon: ie.em })),
    (t = n.marks.code) &&
      (e.toggleCode = Dr(t, { title: "Toggle code font", icon: ie.code })),
    (t = n.marks.link) && (e.toggleLink = oj(t));
  let r;
  if (
    ((r = n.nodes.image) && (e.insertImage = rj(r)),
    (r = n.nodes.bullet_list) &&
      (e.wrapBulletList = gi(r, {
        title: "Wrap in bullet list",
        icon: ie.bulletList,
      })),
    (r = n.nodes.ordered_list) &&
      (e.wrapOrderedList = gi(r, {
        title: "Wrap in ordered list",
        icon: ie.orderedList,
      })),
    (r = n.nodes.blockquote) &&
      (e.wrapBlockQuote = Qt(r, {
        title: "Wrap in block quote",
        icon: ie.blockquote,
      })),
    (r = n.nodes.paragraph) &&
      (e.makeParagraph = zt(r, {
        title: "Change to paragraph",
        label: "Plain",
      })),
    (r = n.nodes.code_block) &&
      (e.makeCodeBlock = zt(r, {
  ...
  return (
    (e.insertMenu = new Es(o([e.insertImage, e.insertHorizontalRule]), {
      label: "Insert",
    })),
    (e.typeMenu = new Es(
      o([
    ...
    (e.blockMenu = [
      o([e.wrapBulletList, e.wrapOrderedList, e.wrapBlockQuote, kf, yf, xf]),
    ]),
...
function sj(n, e) {
  ...
  if (
    ...
    o("Mod-BracketLeft", $r),
    o("Escape", Ur),
    (r = n.marks.strong) && (o("Mod-b", qe(r)), o("Mod-B", qe(r))),
    (r = n.marks.em) && (o("Mod-i", qe(r)), o("Mod-I", qe(r))),
    (r = n.marks.code) && o("Mod-`", qe(r)),
    (r = n.nodes.bullet_list) && o("Shift-Ctrl-8", Kr(r)),
    (r = n.nodes.ordered_list) && o("Shift-Ctrl-9", Kr(r)),
    (r = n.nodes.blockquote) && o("Ctrl->", Hr(r)),
  ...
  if (
    ((r = n.nodes.list_item) &&
      (o("Enter", NH(r)), o("Mod-[", qH(r)), o("Mod-]", FH(r))),
    (r = n.nodes.paragraph) && o("Shift-Ctrl-0", hn(r)),
    (r = n.nodes.code_block) && o("Shift-Ctrl-\\", hn(r)),
    (r = n.nodes.heading))
  )
    for (let s = 1; s <= 6; s++) o("Shift-Ctrl-" + s, hn(r, { level: s }));
  if ((r = n.nodes.horizontal_rule)) {
    let s = r;
    o(
      "Mod-_",
...
function uj(n, e) {
  return Fn(new RegExp("^(#{1," + e + "})\\s$"), n, (t) => ({
    level: t[1].length,
  }));
}
function fj(n) {
  let e = Lf.concat(qf, Nf),
    t;
  return (
    (t = n.nodes.blockquote) && e.push(ij(t)),
    (t = n.nodes.ordered_list) && e.push(lj(t)),
    (t = n.nodes.bullet_list) && e.push(cj(t)),
    (t = n.nodes.code_block) && e.push(aj(t)),
    (t = n.nodes.heading) && e.push(uj(t, 6)),
    Ul({ rules: e })
  );
}
function hj(n) {
  let e = [fj(n.schema), mi(sj(n.schema, n.mapKeys)), mi(tf), jH(), KH()];
  return (
    n.menuBar !== !1 &&
      e.push(
        Sf({
...
window.GovspeakVisualEditor = gj;
